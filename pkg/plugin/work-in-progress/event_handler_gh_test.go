...
var _ = Describe("Test Keeper Plugin features", func() {
	...
	Context("Pull Request title change trigger", func() {
		...
		// It("should mark opened PR as work-in-progress when prefixed with configured WIP", func() {
		// 	// given
		// 	gock.New("https://raw.githubusercontent.com").
		// 		Get("bartoszmajsak/wfswarm-booster-pipeline-test/5d6e9b25da90edfc19f488e595e0645c081c1575/work-in-progress.yml").
		// 		Reply(200).
		// 		Body(FromFile("test_fixtures/github_calls/custom_prefix_pr_opened.json"))
