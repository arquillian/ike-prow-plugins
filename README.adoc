...
[#sample-autoenv]
[source,bash]
.Sample shell script with local dev setup
----
include::local.sh[]
----
...
== Registering plugins for your repositories
...
You can generate it locally. All you need to have in place is https://docs.docker.com/engine/installation/[Docker].
Simply execute
