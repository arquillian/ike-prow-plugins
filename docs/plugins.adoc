...
[source, yml, indent=0]
----
include::../../pkg/plugin/test-keeper/plugin/test_fixtures/github_calls/prs/with_tests/test-keeper.yml[tag="plugin_hint"]
----
...
filename PLUGIN-NAME-HINT.md that contains the hint. The location of the file can be set by either a relative path or an
