...
In addition to managing the status for the PR in progress, it also manages adding/removing the GitHub label (`work-in-progress` by default or configured otherwise) for the given PR. 
